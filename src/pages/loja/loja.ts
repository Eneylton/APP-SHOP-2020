...
export class LojaPage {
  ...
  openListProduto(id){
    ...
    this.navCtrl.push('ListarProdutosPage', {id:id});

  }

  openProduto(id){
    this.navCtrl.push('RegistrarProdutoPage', {id:id});
  }
  
  openRegistrarLoja(){
    this.navCtrl.push('RegistrarLojaPage');
  }
  ...
  openEditar(id,nome,email,tel,whatsapp,facebook,hist,website,cep,endereco,numero,bairro,cidade,estado,foto){
    this.navCtrl.push('EditarLojaPage', {
      id:id,
      nome:nome,
      email:email,
      tel:tel,
